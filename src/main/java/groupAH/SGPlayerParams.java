...
public class SGPlayerParams extends PlayerParameters {
    ...
    public double progressiveBiasWeight = 1;
    ...
    public SGEnums.Policy selectionPolicy = SGEnums.Policy.UCT;
    ...
    public SGPlayerParams() {
        ...
        addTunableParameter("progressiveBiasWeight", 1.0, Arrays.asList(0.0, 0.1, 0.5, 1.0, 2.0, 5.0));
        ...
        addTunableParameter("selectionPolicy", SGEnums.Policy.UCT, Arrays.asList(SGEnums.Policy.values()));
    ...
    public void _reset() {
        ...
        progressiveBiasWeight = (double) getParameterValue("progressiveBiasWeight");
